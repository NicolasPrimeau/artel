...
SETTING_NOTES: dict[str, str] = {
    ...
    "archivist_provider": "`anthropic`, `openai`, or `claude-sdk`.",
    "archivist_model": "Model override. Empty uses the provider default.",
    "archivist_api_key": "Overrides the provider-specific key.",
    "archivist_base_url": "Custom base URL for OpenAI-compatible providers.",
